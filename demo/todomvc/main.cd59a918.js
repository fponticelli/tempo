...
},{"./html_builder":"eyJE","../value":"nFed","./adapter":"kWOh","./match_template":"HSRy","./match_bool_template":"ZVXL","./match_value_template":"oCpq","./lazy":"hzRP","./hold_state":"fYSr","./capture_state":"YmhL"}],"UPGL":[function(require,module,exports) {
"use strict";
/*
Copyright 2019 Google LLC
Licensed under the Apache License, Version 2.0 (the "License");
...
var dom_builder_1 = require("./impl/dom_builder");
var html_1 = require("./impl/html");
exports.Tempo = {
    renderComponent: function (options) {
        var maybeElement = options.el, component = options.component;
        var localState = options.state;
        var doc = options.document || document;
        var el = maybeElement || doc.body;
        var append = function (node) { return el.appendChild(node); };
        var template = dom_builder_1.childOrBuilderToTemplate(component);
        var appliedMiddleware = options.middleware !== undefined
            ? options.middleware(function (action) {
                view.dispatch(action);
            })
            : function () { };
        var view = template.render(new context_1.DOMContext(doc, append, function (action) {
    ...
    render: function (options) {
        var el = options.el, state = options.state, reducer = options.reducer, equal = options.equal, document = options.document, template = options.template, delayed = options.delayed, middleware = options.middleware;
        var component = html_1.Component(reducer, function ($) {
            $.Equals(equal).Delayed(delayed).Append(template);
        });
        return exports.Tempo.renderComponent({
            el: el,
            component: component,
            state: state,
            document: document,
    ...
    renderSimple: function (options) {
        ...
        var template = dom_builder_1.childOrBuilderToTemplate(component);
        var appliedMiddleware = options.middleware !== undefined
            ? options.middleware(function (state) { return result.change(state); })
            : function () { };
        var result = __assign({}, template.render(new context_1.DOMContext(doc, append, function (state) {
...
//# sourceMappingURL=main.cd59a918.js.map