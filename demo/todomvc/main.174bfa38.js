...
function $Utso$var$filterState(props) {
  var children = [];
  ...
  return new $Utso$var$FilterStateTemplate(props.isSame || function (a, b) {
    return a === b;
...
function $GBq0$var$iterate(props) {
  var children = [];
...
function $GBq0$var$iterateItems(props) {
  var children = [];
