...
export declare function template<State, Action>(attributes: TemplateAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTemplateElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
