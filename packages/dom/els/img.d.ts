...
export declare function img<State, Action>(attributes: ImgAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLImageElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
