...
export declare function thead<State, Action>(attributes: TheadAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableSectionElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
