...
export declare function figure<State, Action>(attributes: FigureAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
