...
export declare function param<State, Action>(attributes: ParamAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLParamElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
