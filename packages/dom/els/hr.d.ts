...
export declare function hr<State, Action>(attributes: HrAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLHRElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
