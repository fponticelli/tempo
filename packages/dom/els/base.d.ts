...
export declare function base<State, Action>(attributes: BaseAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLBaseElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
