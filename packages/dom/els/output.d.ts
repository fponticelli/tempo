...
export declare function output<State, Action>(attributes: OutputAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLOutputElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
