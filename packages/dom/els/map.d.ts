...
export declare function map<State, Action>(attributes: MapAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLMapElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
