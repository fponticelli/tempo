...
export declare function address<State, Action>(attributes: AddressAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSpanElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
