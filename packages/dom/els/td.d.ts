...
export declare function td<State, Action>(attributes: TdAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableDataCellElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
