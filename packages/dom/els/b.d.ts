...
export declare function b<State, Action>(attributes: BAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
