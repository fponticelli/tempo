...
export declare function picture<State, Action>(attributes: PictureAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLPictureElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
