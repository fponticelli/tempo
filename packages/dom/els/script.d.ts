...
export declare function script<State, Action>(attributes: ScriptAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLScriptElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
