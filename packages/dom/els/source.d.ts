...
export declare function source<State, Action>(attributes: SourceAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSourceElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
