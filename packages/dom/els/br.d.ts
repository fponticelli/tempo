...
export declare function br<State, Action>(attributes: BrAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLBRElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
