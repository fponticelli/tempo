...
export declare function table<State, Action>(attributes: TableAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
