...
export declare function colgroup<State, Action>(attributes: ColgroupAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableColElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
