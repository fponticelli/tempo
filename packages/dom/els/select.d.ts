...
export declare function select<State, Action>(attributes: SelectAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSelectElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
