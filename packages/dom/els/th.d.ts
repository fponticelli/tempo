...
export declare function th<State, Action>(attributes: ThAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableHeaderCellElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
