...
export declare function col<State, Action>(attributes: ColAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableColElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
