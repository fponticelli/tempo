...
export declare function option<State, Action>(attributes: OptionAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLOptionElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
