...
export interface MetaAttributes<State, Action> {
    ...
    name?: DOMAttribute<State, 'application-name' | 'author' | 'description' | 'generator' | 'keywords' | 'referrer' | 'creator' | 'googlebot' | 'robots' | 'publisher' | 'slurp' | 'viewport'>;
...
export declare function meta<State, Action>(attributes: MetaAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLMetaElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
