...
export declare function time<State, Action>(attributes: TimeAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTimeElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
