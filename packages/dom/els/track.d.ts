...
export declare function track<State, Action>(attributes: TrackAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTrackElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
