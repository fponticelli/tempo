...
export declare function dir<State, Action>(attributes: DirAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDirectoryElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
