...
export declare function kbd<State, Action>(attributes: KbdAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
