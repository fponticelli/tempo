...
export declare function audio<State, Action>(attributes: AudioAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLAudioElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
