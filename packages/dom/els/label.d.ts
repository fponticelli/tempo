...
export declare function label<State, Action>(attributes: LabelAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLLabelElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
