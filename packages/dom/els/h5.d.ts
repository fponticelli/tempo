...
export declare function h5<State, Action>(attributes: H5Attributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLHeadingElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
