...
export declare function div<State, Action>(attributes: DivAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDivElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
