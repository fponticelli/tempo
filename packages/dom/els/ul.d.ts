...
export declare function ul<State, Action>(attributes: UlAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLUListElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
