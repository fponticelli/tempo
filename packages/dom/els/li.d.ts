...
export declare function li<State, Action>(attributes: LiAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLLIElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
