...
export declare function dfn<State, Action>(attributes: DfnAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
