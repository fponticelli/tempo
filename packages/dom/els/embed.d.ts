...
export declare function embed<State, Action>(attributes: EmbedAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLEmbedElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
