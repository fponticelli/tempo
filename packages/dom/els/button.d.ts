...
export declare function button<State, Action>(attributes: ButtonAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLButtonElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
