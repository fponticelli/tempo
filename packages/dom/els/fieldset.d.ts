...
export declare function fieldset<State, Action>(attributes: FieldsetAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLFieldSetElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
