...
export declare function link<State, Action>(attributes: LinkAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLLinkElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
