...
export declare function area<State, Action>(attributes: AreaAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLAreaElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
