...
export declare function a<State, Action>(attributes: AAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLAnchorElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
