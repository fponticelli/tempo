...
export declare function form<State, Action>(attributes: FormAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLFormElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
