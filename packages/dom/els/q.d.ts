...
export declare function q<State, Action>(attributes: QAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLQuoteElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
