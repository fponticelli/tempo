...
export declare function title<State, Action>(attributes: TitleAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTitleElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
