...
export declare function dl<State, Action>(attributes: DlAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDListElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
