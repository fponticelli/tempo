...
export declare function ins<State, Action>(attributes: InsAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLModElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
//# sourceMappingURL=ins.d.ts.map