...
export declare function code<State, Action>(attributes: CodeAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSpanElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
