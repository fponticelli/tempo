...
export declare function ol<State, Action>(attributes: OlAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLOListElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
