...
export declare function bdo<State, Action>(attributes: BdoAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSpanElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
//# sourceMappingURL=bdo.d.ts.map