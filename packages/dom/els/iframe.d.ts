...
export declare function iframe<State, Action>(attributes: IframeAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLIFrameElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
