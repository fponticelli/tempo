...
export declare function blockquote<State, Action>(attributes: BlockquoteAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLQuoteElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
