...
export declare function dt<State, Action>(attributes: DtAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLSpanElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
