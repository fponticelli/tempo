...
export declare function object<State, Action>(attributes: ObjectAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLObjectElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
