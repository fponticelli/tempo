...
export declare function dialog<State, Action>(attributes: DialogAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDialogElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
