...
export declare function tfoot<State, Action>(attributes: TfootAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableSectionElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
