...
export declare function h4<State, Action>(attributes: H4Attributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLHeadingElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
