...
export declare function pre<State, Action>(attributes: PreAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLPreElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
