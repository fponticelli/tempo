...
export declare function tr<State, Action>(attributes: TrAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableRowElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
