...
export declare function canvas<State, Action>(attributes: CanvasAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLCanvasElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
