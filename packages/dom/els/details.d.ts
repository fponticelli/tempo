...
export declare function details<State, Action>(attributes: DetailsAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDetailsElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
