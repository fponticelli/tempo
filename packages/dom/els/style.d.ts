...
export declare function style<State, Action>(attributes: StyleAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLStyleElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
