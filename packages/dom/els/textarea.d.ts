...
export declare function textarea<State, Action>(attributes: TextareaAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTextAreaElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
