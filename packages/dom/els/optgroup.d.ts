...
export declare function optgroup<State, Action>(attributes: OptgroupAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLOptGroupElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
