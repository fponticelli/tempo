...
export declare function body<State, Action>(attributes: BodyAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLBodyElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
