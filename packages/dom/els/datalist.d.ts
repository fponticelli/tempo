...
export declare function datalist<State, Action>(attributes: DatalistAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDataListElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
