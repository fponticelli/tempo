...
export declare function head<State, Action>(attributes: HeadAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLHeadElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
