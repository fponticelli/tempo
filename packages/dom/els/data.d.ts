...
export declare function data<State, Action>(attributes: DataAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLDataElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
