...
export declare function p<State, Action>(attributes: PAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLParagraphElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
