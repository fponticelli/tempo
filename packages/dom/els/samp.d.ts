...
export declare function samp<State, Action>(attributes: SampAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
//# sourceMappingURL=samp.d.ts.map