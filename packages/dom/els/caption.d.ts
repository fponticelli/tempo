...
export declare function caption<State, Action>(attributes: CaptionAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableCaptionElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
