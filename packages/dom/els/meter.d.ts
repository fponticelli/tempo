...
export declare function meter<State, Action>(attributes: MeterAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLMeterElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
