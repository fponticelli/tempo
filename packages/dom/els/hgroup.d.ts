...
export declare function hgroup<State, Action>(attributes: HgroupAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
//# sourceMappingURL=hgroup.d.ts.map