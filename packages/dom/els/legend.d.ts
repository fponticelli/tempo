...
export declare function legend<State, Action>(attributes: LegendAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLLegendElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
