...
export declare function html<State, Action>(attributes: HtmlAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLHtmlElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
