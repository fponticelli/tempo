...
export declare function tbody<State, Action>(attributes: TbodyAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTableSectionElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
