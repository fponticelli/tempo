...
export declare function progress<State, Action>(attributes: ProgressAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLProgressElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
