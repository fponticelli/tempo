...
export declare function video<State, Action>(attributes: VideoAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLVideoElement>, ...children: DOMChild<State, Action>[]): DOMElement<State, Action>;
