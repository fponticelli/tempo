...
export interface TfootAttributes<State, Action> {
...
export const tfoot = <State, Action>(
  attributes: TfootAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('tfoot', attributes, ...children)
