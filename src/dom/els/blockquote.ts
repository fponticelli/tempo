...
export interface BlockquoteAttributes<State, Action> {
...
export const blockquote = <State, Action>(
  attributes: BlockquoteAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('blockquote', attributes, ...children)
