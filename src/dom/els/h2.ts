...
export interface H2Attributes<State, Action> {
...
export const h2 = <State, Action>(attributes: H2Attributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('h2', attributes, ...children)
