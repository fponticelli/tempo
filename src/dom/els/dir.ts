...
export interface DirAttributes<State, Action> {
...
export const dir = <State, Action>(attributes: DirAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('dir', attributes, ...children)
