...
export interface UlAttributes<State, Action> {
...
export const ul = <State, Action>(attributes: UlAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('ul', attributes, ...children)
