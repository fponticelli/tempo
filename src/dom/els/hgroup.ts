...
export interface HgroupAttributes<State, Action> {
...
export const hgroup = <State, Action>(
  attributes: HgroupAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('hgroup', attributes, ...children)
