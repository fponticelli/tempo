...
export interface H6Attributes<State, Action> {
...
export const h6 = <State, Action>(attributes: H6Attributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('h6', attributes, ...children)
