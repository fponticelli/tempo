...
export interface OptgroupAttributes<State, Action> {
...
export const optgroup = <State, Action>(
  attributes: OptgroupAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('optgroup', attributes, ...children)
