...
export interface BAttributes<State, Action> {
...
export const b = <State, Action>(attributes: BAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('b', attributes, ...children)
