...
export interface KbdAttributes<State, Action> {
...
export const kbd = <State, Action>(attributes: KbdAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('kbd', attributes, ...children)
