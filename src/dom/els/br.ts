...
export interface BrAttributes<State, Action> {
...
export const br = <State, Action>(attributes: BrAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('br', attributes, ...children)
