...
export interface RpAttributes<State, Action> {
...
export const rp = <State, Action>(attributes: RpAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('rp', attributes, ...children)
