...
export interface AsideAttributes<State, Action> {
...
export const aside = <State, Action>(
  attributes: AsideAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('aside', attributes, ...children)
