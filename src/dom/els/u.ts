...
export interface UAttributes<State, Action> {
...
export const u = <State, Action>(attributes: UAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('u', attributes, ...children)
