...
export interface NavAttributes<State, Action> {
...
export const nav = <State, Action>(attributes: NavAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('nav', attributes, ...children)
