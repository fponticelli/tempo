...
export interface SupAttributes<State, Action> {
...
export const sup = <State, Action>(attributes: SupAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('sup', attributes, ...children)
