...
export interface DfnAttributes<State, Action> {
...
export const dfn = <State, Action>(attributes: DfnAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('dfn', attributes, ...children)
