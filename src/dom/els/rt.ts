...
export interface RtAttributes<State, Action> {
...
export const rt = <State, Action>(attributes: RtAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('rt', attributes, ...children)
