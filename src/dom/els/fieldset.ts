...
export interface FieldsetAttributes<State, Action> {
...
export const fieldset = <State, Action>(
  attributes: FieldsetAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('fieldset', attributes, ...children)
