...
export interface CiteAttributes<State, Action> {
...
export const cite = <State, Action>(
  attributes: CiteAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('cite', attributes, ...children)
