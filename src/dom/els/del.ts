...
export interface DelAttributes<State, Action> {
...
export const del = <State, Action>(attributes: DelAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('del', attributes, ...children)
