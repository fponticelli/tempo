...
export interface SAttributes<State, Action> {
...
export const s = <State, Action>(attributes: SAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('s', attributes, ...children)
