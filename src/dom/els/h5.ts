...
export interface H5Attributes<State, Action> {
...
export const h5 = <State, Action>(attributes: H5Attributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('h5', attributes, ...children)
