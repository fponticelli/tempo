...
export interface TrAttributes<State, Action> {
...
export const tr = <State, Action>(attributes: TrAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('tr', attributes, ...children)
