...
export interface NoscriptAttributes<State, Action> {
...
export const noscript = <State, Action>(
  attributes: NoscriptAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('noscript', attributes, ...children)
