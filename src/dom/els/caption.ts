...
export interface CaptionAttributes<State, Action> {
...
export const caption = <State, Action>(
  attributes: CaptionAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('caption', attributes, ...children)
