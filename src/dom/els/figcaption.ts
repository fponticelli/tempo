...
export interface FigcaptionAttributes<State, Action> {
...
export const figcaption = <State, Action>(
  attributes: FigcaptionAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('figcaption', attributes, ...children)
