...
export interface H1Attributes<State, Action> {
...
export const h1 = <State, Action>(attributes: H1Attributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('h1', attributes, ...children)
