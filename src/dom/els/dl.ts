...
export interface DlAttributes<State, Action> {
...
export const dl = <State, Action>(attributes: DlAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('dl', attributes, ...children)
