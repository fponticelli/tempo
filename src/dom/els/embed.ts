...
export interface EmbedAttributes<State, Action> {
...
export const embed = <State, Action>(
  attributes: EmbedAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('embed', attributes, ...children)
