...
export interface BdiAttributes<State, Action> {
...
export const bdi = <State, Action>(attributes: BdiAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('bdi', attributes, ...children)
