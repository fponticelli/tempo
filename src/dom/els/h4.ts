...
export interface H4Attributes<State, Action> {
...
export const h4 = <State, Action>(attributes: H4Attributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('h4', attributes, ...children)
