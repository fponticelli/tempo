...
export interface PAttributes<State, Action> {
...
export const p = <State, Action>(attributes: PAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('p', attributes, ...children)
