...
export interface StrongAttributes<State, Action> {
...
export const strong = <State, Action>(
  attributes: StrongAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('strong', attributes, ...children)
