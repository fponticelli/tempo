...
export interface PreAttributes<State, Action> {
...
export const pre = <State, Action>(attributes: PreAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('pre', attributes, ...children)
