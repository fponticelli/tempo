...
export interface DivAttributes<State, Action> {
...
export const div = <State, Action>(attributes: DivAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('div', attributes, ...children)
