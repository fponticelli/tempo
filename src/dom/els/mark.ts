...
export interface MarkAttributes<State, Action> {
...
export const mark = <State, Action>(
  attributes: MarkAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('mark', attributes, ...children)
