...
export interface DtAttributes<State, Action> {
...
export const dt = <State, Action>(attributes: DtAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('dt', attributes, ...children)
