...
export interface SpanAttributes<State, Action> {
...
export const span = <State, Action>(
  attributes: SpanAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('span', attributes, ...children)
