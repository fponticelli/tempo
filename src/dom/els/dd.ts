...
export interface DdAttributes<State, Action> {
...
export const dd = <State, Action>(attributes: DdAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('dd', attributes, ...children)
