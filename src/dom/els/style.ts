...
export interface StyleAttributes<State, Action> {
...
export const style = <State, Action>(
  attributes: StyleAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('style', attributes, ...children)
