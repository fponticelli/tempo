...
export interface TbodyAttributes<State, Action> {
...
export const tbody = <State, Action>(
  attributes: TbodyAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('tbody', attributes, ...children)
