...
export interface HrAttributes<State, Action> {
...
export const hr = <State, Action>(attributes: HrAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('hr', attributes, ...children)
