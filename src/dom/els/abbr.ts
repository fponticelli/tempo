...
export interface AbbrAttributes<State, Action> {
...
export const abbr = <State, Action>(
  attributes: AbbrAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('abbr', attributes, ...children)
