...
export interface LegendAttributes<State, Action> {
...
export const legend = <State, Action>(
  attributes: LegendAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('legend', attributes, ...children)
