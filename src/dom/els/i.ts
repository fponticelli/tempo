...
export interface IAttributes<State, Action> {
...
export const i = <State, Action>(attributes: IAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('i', attributes, ...children)
