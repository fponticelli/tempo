...
export interface LiAttributes<State, Action> {
...
export const li = <State, Action>(attributes: LiAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('li', attributes, ...children)
