...
export interface PictureAttributes<State, Action> {
...
export const picture = <State, Action>(
  attributes: PictureAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('picture', attributes, ...children)
