...
export interface TheadAttributes<State, Action> {
...
export const thead = <State, Action>(
  attributes: TheadAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('thead', attributes, ...children)
