...
export interface EmAttributes<State, Action> {
...
export const em = <State, Action>(attributes: EmAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('em', attributes, ...children)
