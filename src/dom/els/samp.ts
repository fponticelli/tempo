...
export interface SampAttributes<State, Action> {
...
export const samp = <State, Action>(
  attributes: SampAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('samp', attributes, ...children)
