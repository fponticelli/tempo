...
export interface InsAttributes<State, Action> {
...
export const ins = <State, Action>(attributes: InsAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('ins', attributes, ...children)
