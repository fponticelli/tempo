...
export interface SmallAttributes<State, Action> {
...
export const small = <State, Action>(
  attributes: SmallAttributes<State, Action>,
  ...children: DOMChild<State, Action>[]
) => el<State, Action>('small', attributes, ...children)
