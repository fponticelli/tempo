...
export interface WbrAttributes<State, Action> {
...
export const wbr = <State, Action>(attributes: WbrAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('wbr', attributes, ...children)
