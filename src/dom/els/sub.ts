...
export interface SubAttributes<State, Action> {
...
export const sub = <State, Action>(attributes: SubAttributes<State, Action>, ...children: DOMChild<State, Action>[]) =>
  el<State, Action>('sub', attributes, ...children)
