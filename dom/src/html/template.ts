...
export interface TemplateAttributes<State, Action> {
...
export function template<State, Action>(
  attributes: TemplateAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLTemplateElement>,
