...
export interface RtcAttributes<State, Action> {
...
export function rtc<State, Action>(
  attributes: RtcAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>,
  ...children: DOMChild<State, Action>[]
): DOMElement<State, Action> {
  return el<State, Action>('rtc', attributes, ...children)
}
