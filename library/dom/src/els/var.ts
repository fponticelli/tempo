...
export interface HtmlVarAttributes<State, Action> {
...
export function htmlVar<State, Action>(
  attributes: HtmlVarAttributes<State, Action> & CSSAttributes<State> & MoodAttributes<State, HTMLElement>,
