...
export interface AcronymAttributes<State> {
...
export const acronym = <State, Action>(attributes: AcronymAttributes<State>, ...children: DOMChild<State, Action>[]) => {
  return el<State, Action>('acronym', attributes, children)
}
